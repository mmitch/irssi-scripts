# $Id: 4chan.pl,v 1.24 2007-01-21 19:54:01 mitch Exp $
#
...
my $CVSVERSION = do { my @r = (q$Revision: 1.24 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
my $CVSDATE = (split(/ /, '$Date: 2007-01-21 19:54:01 $'))[1];
$VERSION = $CVSVERSION;
%IRSSI = (
