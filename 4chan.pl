# $Id: 4chan.pl,v 1.25 2007-01-21 20:06:03 mitch Exp $
#
...
my $CVSVERSION = do { my @r = (q$Revision: 1.25 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
my $CVSDATE = (split(/ /, '$Date: 2007-01-21 20:06:03 $'))[1];
$VERSION = $CVSVERSION;
%IRSSI = (
