# $Id: 4chan.pl,v 1.29 2007-05-17 10:57:11 mitch Exp $
#
...
my $CVSVERSION = do { my @r = (q$Revision: 1.29 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
my $CVSDATE = (split(/ /, '$Date: 2007-05-17 10:57:11 $'))[1];
$VERSION = $CVSVERSION;
%IRSSI = (
