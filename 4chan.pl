# $Id: 4chan.pl,v 1.28 2007-05-17 10:34:03 mitch Exp $
#
...
my $CVSVERSION = do { my @r = (q$Revision: 1.28 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
my $CVSDATE = (split(/ /, '$Date: 2007-05-17 10:34:03 $'))[1];
$VERSION = $CVSVERSION;
%IRSSI = (
